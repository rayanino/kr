...
class NormErrorCode(str, Enum):
    ...
    DIACRITICS_ENTITY_CORRUPTION = "NORM_DIACRITICS_ENTITY_CORRUPTION"
    ENRICHMENT_WRITEBACK_FAILED = "NORM_ENRICHMENT_WRITEBACK_FAILED"
    ORPHAN_FOOTNOTE_REF = "NORM_ORPHAN_FOOTNOTE_REF"
    SUSPICIOUS_PAGEHEAD = "NORM_SUSPICIOUS_PAGEHEAD"
    CONTINUITY_INCONSISTENT = "NORM_CONTINUITY_INCONSISTENT"
    CONTINUITY_UNKNOWN = "NORM_CONTINUITY_UNKNOWN"
    MIDWORD_BREAK = "NORM_MIDWORD_BREAK"
    VOLUME_MISMATCH = "NORM_VOLUME_MISMATCH"
    VOLUME_NUMBER_UNPARSEABLE = "NORM_VOLUME_NUMBER_UNPARSEABLE"
    WRITE_RECOVERY = "NORM_WRITE_RECOVERY"
    FOOTNOTE_CLASSIFICATION_FAILED = "NORM_FOOTNOTE_CLASSIFICATION_FAILED"
...
ERROR_SEVERITY: dict[NormErrorCode, ErrorSeverity] = {
    ...
    NormErrorCode.DIACRITICS_ENTITY_CORRUPTION: ErrorSeverity.FATAL,
    NormErrorCode.ENRICHMENT_WRITEBACK_FAILED: ErrorSeverity.WARNING,
    NormErrorCode.ORPHAN_FOOTNOTE_REF: ErrorSeverity.INFO,
    NormErrorCode.SUSPICIOUS_PAGEHEAD: ErrorSeverity.WARNING,
    NormErrorCode.CONTINUITY_INCONSISTENT: ErrorSeverity.WARNING,
    NormErrorCode.CONTINUITY_UNKNOWN: ErrorSeverity.INFO,
    NormErrorCode.MIDWORD_BREAK: ErrorSeverity.WARNING,
    NormErrorCode.VOLUME_MISMATCH: ErrorSeverity.WARNING,
    NormErrorCode.VOLUME_NUMBER_UNPARSEABLE: ErrorSeverity.WARNING,
    NormErrorCode.WRITE_RECOVERY: ErrorSeverity.INFO,
    NormErrorCode.FOOTNOTE_CLASSIFICATION_FAILED: ErrorSeverity.INFO,
}
