...
**Supported external-answer mirror:** `integration_tests/questionnaire/external_questionnaire_responses.json`
for owner answers preserved outside the UI but normalized into a stable local artifact.
...
JSONL exists if it does not. If a stable external mirror exists, use it and cite
the underlying artifact paths it points to.
...
SCOPE: integration_tests/questionnaire/questionnaire_responses.jsonl and/or integration_tests/questionnaire/external_questionnaire_responses.json
CHECKS:
...
CONTEXT: Read the owner's completed questionnaire at integration_tests/questionnaire/questionnaire_responses.jsonl and/or integration_tests/questionnaire/external_questionnaire_responses.json
...
CONTEXT: Read the completed questionnaire at integration_tests/questionnaire/questionnaire_responses.jsonl and/or integration_tests/questionnaire/external_questionnaire_responses.json
...
- `external_questionnaire_responses.json`
