# استبيان تقييم المقتطفات — Excerpt Evaluation Questionnaire
...
**How to respond:** Open `RESPONSE_FORMAT.md` alongside this document. It shows the exact template for each response. Most interactions use the Standard Response format. Some are marked **[EDGE CASE]** and use the extended format with two additional fields.
...
These questions establish your vocabulary, your study habits, and your instinctive reactions before any discussion of trade-offs.
...
In your own words: what is an excerpt? Not a dictionary definition --- what does it mean to YOU when you open your library and read one piece of knowledge? What makes something feel like a complete, useful piece of knowledge versus a random fragment?
...
Describe your ideal study session. You sit down to study a fiqh topic --- say, the rulings of prayer or fasting. What do you open first? What are you looking for? Walk me through 30 minutes of studying. Where do you start, what do you read, when do you stop on one thing and move to another?

---

## F-3 --- Excerpt A

Read this excerpt. It introduces the section on wiping over leather socks (المسح على الخفين) and establishes its legal basis.
...
Tell me everything you are thinking. Your reaction, what is good about this, what is missing, what you would change if anything. Take your time.

---

## F-4 --- Excerpt B

Read this excerpt. It discusses the scholarly disagreement about the hand that is cut (in the ruling on theft).

> واختلف العلماء في حقيقة اليد التي تقطع على أقوال: وأصحها، ما ذهب إليه الجمهور،

_Source: Taysir al-Allam / campaign run / Claude Opus classification_

Tell me everything you are thinking. Your reaction, what is good about this, what is missing, what you would change if anything.

---

## F-5 --- An Excerpt With a Summary Note

This excerpt comes with a note explaining what came before it. Read both.

**The note:**

> هذا شرح لحديث عبد الله بن عمر أنه طلق امرأته وهي حائض فأمره النبي صلى الله عليه وسلم بمراجعتها.
...
Read this hadith with its full narrative. It is the hadith of Fatimah bint Qays about her divorce.
...
When you study this text, which parts do you focus on? Are there parts that slow you down or that you skip? Would you want any kind of help understanding the text --- or do you always want the author's original words without any changes?

---

## F-7 --- The Worst Failure

_No excerpt to read._

What failure would make you stop using the library? What is the worst thing it could do to your study? Think about specific scenarios --- what kind of mistake would damage your trust completely?
...
Now we explore specific qualities of excerpts. Each interaction focuses on one dimension and pushes into edge cases.

---

## Granularity --- How Big Should an Excerpt Be?

---

### G-1 --- A Very Short Structural Transition

Read this excerpt. It is a brief structural transition that announces the discussion plan for a hadith --- only 53 characters long.
...
This excerpt is very long. Does it feel like one topic, or should it be split? If you think it should be split, where exactly would you draw the line? Point to the place in the text where one topic ends and another begins.

---

### G-3 --- Numbered Points

Read this excerpt. It contains a scholarly opinion with references to multiple legal schools.
...
This text is numbered "2-" --- it is one point from a longer list of benefits extracted from a hadith. Should each numbered point be its own excerpt in the library, or do all the points belong together as one entry? What would you prefer when studying?

**Follow-up:** If the numbered list has 8 points, and each point is about a different ruling, should they still all be in one entry?

---

### G-4 --- An Exception to a Ruling

Read this excerpt. It lists conditions for cutting the hand of a thief, but begins by saying "some conditions were mentioned earlier."

**The note:**

> من الشروط المتقدمة لقطع يد السارق: بلوغ النصاب، وكون السارق مكلفاً بالغاً عاقلاً، وأن يكون المسروق مالاً محترماً
...
This is a set of additional conditions for a ruling --- it explicitly says some conditions were already mentioned earlier. Should it be its own excerpt, or should it be combined with the earlier conditions into one complete entry?

**Follow-up:** If the exception only makes sense after you have read the earlier conditions, should they always be kept together in one entry?

---

## Self-Containment --- Can You Understand It Alone?

---

### SC-1 --- A Summary of Earlier Discussion [EDGE CASE]

Read this excerpt. It begins by summarizing a previous discussion about the definition of alcohol (khamr).

**The note:**

> سبق في الكتاب بيان أن الخمر كل مسكر من أي مادة كان، وأن العلماء اختلفوا في حده بين من قصره على عصير العنب ومن عمّمه
...
This excerpt summarizes what came before in a short note. Is that summary enough to understand what follows, or do you still feel lost?

**Follow-up:** What would change your mind? When is a summary note enough, and when is it not?

---

### SC-2 --- A Backward Reference [EDGE CASE]

Read this excerpt. It discusses additional benefits from a hadith about wudu, and it frequently refers to "the previous hadith" (الحديث السابق).
...
This excerpt repeatedly refers to "the previous hadith" without repeating it. How do you feel reading it without the previous hadith in front of you? Can you still benefit from this excerpt without seeing the previous hadith right in front of you?

**Follow-up:** Should the library try to find and link what was mentioned earlier? Or is it enough to simply note that a reference to earlier material exists?

---

### SC-3 --- Assumed Chapter Context

Read this excerpt. It is part of a hadith about the proper way to pray, describing the postures of standing straight (اعتدال) and prostration.

> وتطمئن في اعتدالك ⌜1⌝ ثم اسجد حتى تطمئن ساجداً، ثم ارفع من السجود واجلس حتى تطمئن جالساً.
> وافعل هذه الأفعال والأقوال في صلاتك كلها، ماعدا تكبيرة الإحرام، فإنها في الركعة الأولى دون غيرها من الركعات.

_Source: Taysir al-Allam / campaign run / Claude Opus classification_

This excerpt assumes you know which hadith is being discussed and what came before --- it begins mid-instruction. Can you understand it on its own, or does it need more context?

---

## Definition Handling --- Together or Separate?

---

### D-1 --- A Short Definition [EDGE CASE]

Read this excerpt. It defines "divorce" (الطلاق) --- both its linguistic meaning and its legal meaning.
...
If a definition like this has both a linguistic meaning (لغة) and a legal or technical meaning (اصطلاحا/شرعا), should they be one excerpt or two separate ones?

**Follow-up:** What if the technical definition is only 4 words long? Still separate?

---

### D-2 --- A Definition With a Connecting Explanation [EDGE CASE]

Read this excerpt. It explains the meanings of unusual words (gharib) from the hadith of Fatimah bint Qays about her divorce.
...
This text defines multiple words, each with its linguistic root and the specific meaning in context. Each word definition connects back to the hadith it explains. Should each word be its own excerpt, or do they belong together because they all explain the same hadith?

**Follow-up:** What principle does this reveal about when definitions should stay together versus when they should be separated?

---

### D-3 --- A Multi-Layered Definition

Read this excerpt. It defines "kalalah" (inheritance when there are no parents or children).
...
If a term has THREE definitions --- a linguistic meaning (لغة), a technical meaning (اصطلاحا), and a school-specific meaning (like "according to the Hanbalis" عند الحنابلة) --- should these be one excerpt, two, or three?

---

## Evidence Handling --- How Should Proofs Be Organized?
...
### E-2 --- A Hadith as Evidence [EDGE CASE]

Read this excerpt. It is the hadith of Abdullah ibn Umar about divorcing his wife during her menstruation.
...
This hadith is used as evidence for rulings about divorce. Should the hadith text and the ruling it supports be in the same excerpt, or separate? When you study, do you want to see the proof right next to the ruling, or do you want to study the hadith on its own first?

**Follow-up:** What would change your mind? Under what circumstances would you answer differently?

---

### E-3 --- Evidence From Multiple Source Types [EDGE CASE]

Read this excerpt. It establishes the legal basis of divorce (الطلاق) by citing evidence from the Quran, the Sunnah, scholarly consensus, and analogical reasoning --- all in one passage.
...
This passage cites four types of evidence (Quran, hadith, consensus, analogy) all to establish one ruling. Should each type of evidence be its own excerpt, or do they belong together because they all serve the same purpose?

**Follow-up:** What principle does this reveal about how evidence and examples should be organized in the library?

---

## Scholarly Disagreement --- Separate or Together?

---

### K-1 --- A Multi-Position Debate

Read this excerpt again (you saw it in G-3). It presents a scholarly disagreement about whether the Prophet's command to take back a divorced wife was obligatory or recommended.
...
When scholars disagree on a ruling, do you want all their positions in one place, or each position as its own separate entry that you navigate between? Which approach helps you learn better?

---

### K-2 --- A Shorter Disagreement

Read this excerpt. It presents one position in the scholarly debate about how many breastfeedings establish the prohibition of marriage.
...
> ودليل هؤلاء، ما ثبت في صحيح (مسلم) عن عائشة رضي الله عنها قالت:

_Source: Taysir al-Allam / campaign run / Claude Opus classification_

This is labeled "a third group" --- meaning there are at least two other positions before it that you do not see here. Does the same rule you stated in K-1 apply here? Should all positions be together?

**Follow-up:** At what point does a scholarly debate become too long for one excerpt? Is there a limit where you would prefer it split even if it means navigating between entries?

---

### K-3 --- Linked Positions

_No excerpt to read._

Imagine the library separates each scholar's position into its own individual entry, but connects them with links: "See also: Hanafi position on this issue," "See also: Shafi'i position on this issue." Is that useful, or confusing? Would you rather see the whole debate laid out in one view?

---

## Genre Differences --- Does the Science Matter?

---

### GN-1 --- Three Sciences Side by Side

Read these three excerpts. Each comes from a different Islamic science.

**Excerpt A --- Fiqh (Islamic Law)**

From: _Taysir al-Allam Sharh Umdat al-Ahkam_ by Abdullah al-Bassam
...
**Excerpt B --- Nahw (Arabic Grammar)**

From: _Sharh Ibn Aqil ala Alfiyyat Ibn Malik_ by Ibn Aqil
...
**Excerpt C --- Usul al-Nahw (Foundations of Grammar)**

From: _al-Iqtirah fi Usul al-Nahw_ by al-Suyuti

> الكتاب الأول
>
> في السماع وأعني به ما ثبت في كلام من يوثق بفصاحته، فشمل كلام الله تعالى، وكلام نبيه صلى الله عليه وسلم، وكلام العرب، قبل بعثته، وفي زمنه، وبعده، إلى أن فسدت الألسنة بكثرة المولدين، نظما ونثرا، عن مسلم أو كافر.
> فهذه ثلاثة أنواع، لابد في كل منها من الثبوت.

_Source: al-Iqtirah fi Usul al-Nahw / campaign run / Claude Opus classification_

Look at these three excerpts from three different Islamic sciences. Do they feel like the same kind of "excerpt" to you, or fundamentally different? Does the way knowledge is structured in fiqh feel different from how it works in grammar or in the foundations of grammar?

**Follow-up:** Should the library handle excerpts from different sciences differently, or should it treat them all the same way?
...
## Layer Handling --- Author vs. Editor

---

### L-1 --- An Editor's Commentary

Read this excerpt. It is a reflection on the wisdom of Islamic divorce legislation, comparing it to other religions and civilizations.
...
This is a note added by the book's author (al-Bassam) as his own commentary and reflection --- it is not a hadith, not a ruling, and not a quote from another scholar. Should it be part of the same excerpt as the rulings it accompanies, or should it be its own separate entry? And who should it be attributed to --- the author of the book, or the original scholars he is commenting on?
...
### QA-1 --- A Scholarly Objection and Response

Read this passage from a book about the principles of Arabic grammar (al-Iqtirah by al-Suyuti). It presents a scholarly objection, then a formal response.
...
### SC-4 --- When the System Is Not Sure

_No excerpt to read._

Sometimes the system produces an excerpt but is not confident it is correct --- maybe the boundaries are uncertain, or it cannot determine if the excerpt stands on its own. When this happens, should the library: (a) show the excerpt anyway with a small warning note, (b) hide it completely until a human has reviewed and approved it, or (c) show it but mark it clearly so you know it needs checking? What level of imperfection are you willing to accept?

---

# Phase 3: Comparative Judgment

These interactions ask you to compare alternatives and choose.

---

## CJ-1 --- Three Ways to Organize Evidence

Look at the excerpt from E-3 again (the passage establishing the evidence for divorce from four source types).

Now imagine three versions of this passage in your library:

**(A) All together, exactly as it appears above.** One single entry with the ruling and all four types of evidence (Quran, hadith, consensus, analogy) together.

**(B) Split by evidence type.** One entry for the Quranic evidence, one for the hadith evidence, one for the consensus, one for the analogical reasoning. Each entry contains only its type of proof.

**(C) Split into even smaller pieces.** The general ruling ("divorce is established in all four sources") is one entry. Each evidence type's specific citation is another entry. The concluding analogy (marriage is contracted by agreement so it can be dissolved by divorce) is yet another entry.

Which version would you most want to study from? Which would be most useful when you are learning? Which would be most frustrating?
...
## CJ-4 --- Metadata Alongside the Text

Read this excerpt about opening supplications in prayer, shown here with the information the library would display alongside it.

**Book:** Taysir al-Allam Sharh Umdat al-Ahkam
**Author:** Abdullah al-Bassam
**School:** Hanbali
**Topic area:** Prayer --- Opening supplication
...
> وينبغي للمصلي أن لا يقتصر دائماً على واحد منها، بل يقولها كلها، ليحصل له كمال الاقتداء، وإحياء جميع السنة فيها، ويجعل القصار لصلاة الجماعة، والطوال لصلاة الليل.

_Source: Taysir al-Allam / campaign run / Claude Opus classification_

When you read this excerpt, what information do you need alongside it? Is the book title, author name, school, and topic area enough? Is anything missing? Is anything shown that you do not care about?

---

# Phase 4: Synthesis

These final questions ask you to pull together everything you have said so far.

---

## S-1 --- Ranking What Matters

_No excerpt to read._

Looking back at everything you have reviewed, rank these qualities from most important to least important:

1. The excerpt stands on its own --- you do not need to read anything else to understand it
2. The excerpt covers exactly one topic --- it is precisely focused
3. The excerpt uses the author's original words
4. Related excerpts are connected --- you can easily navigate from one to another
5. Evidence (Quran, hadith, scholarly arguments) is organized by type so you can find it

When two of these qualities conflict --- for example, making an excerpt stand on its own requires adding text that makes it cover more than one topic --- which quality wins?

---

## S-1b --- The Cost of Granularity

_No excerpt to read._

Following your preferences throughout this questionnaire may mean the library has 3 to 5 times as many entries, each shorter and more precisely focused. Is that better or worse than fewer, longer entries? At what point do you have "too many" entries on a single topic --- or is there no such thing as too many if each one is useful?

---

## S-1c --- A Real Conflict

Imagine this situation: an excerpt covers a ruling and an exception to that ruling. Keeping them together means the excerpt covers two topics (the ruling and the exception). Splitting them means neither part stands completely on its own --- the exception only makes sense if you know the ruling. Which do you prefer: one longer entry that mixes topics, or two shorter entries where one depends on the other?

---

## S-2 --- The Ideal and the Worst

_No excerpt to read._

In your own words, describe the IDEAL excerpt. What does it look like? How long is it? What context surrounds it? What information is displayed alongside it? Be as detailed as possible.

Then describe the WORST excerpt --- what makes an excerpt useless or harmful to your study? What specific qualities would make you distrust the library?

---

## S-3 --- Your Contradictions

_No excerpt to read._

Looking back at your answers throughout this questionnaire: did you notice yourself being inconsistent anywhere? Were there moments where you gave one answer but then later said something that contradicts it? Where are you least sure?

Is there anything about how you imagine using your library that we have not covered in these questions?

---

# After You Finish

Your responses go through a structured review process:
