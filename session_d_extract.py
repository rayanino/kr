#!/usr/bin/env python3
"""Session D verdict-ready data extractor.
...
Usage: python3 session_d_extract.py "book_name"
       python3 session_d_extract.py --all  (all 15 Session D books)
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 session_d_extract.py 'book_name' | --all")
        sys.exit(1)

    if sys.argv[1] == "--all":
        for book in SESSION_D_BOOKS:
            extract_book(book)
    else:
