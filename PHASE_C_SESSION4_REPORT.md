...
**Web Sources:** archive.org ×2, Goodreads (3 independent) + shamela.ws, ketabpedia (Shamela-ecosystem)
...
- web_fetch success rate: relied on search snippets (per mid-session check). Future sessions should attempt more fetches.
- read_book.py helper worked for all 10 books.
