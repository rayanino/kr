...
The taxonomy engine IS the map of the owner's knowledge. Its tree structure makes each science's internal logic visible. A misplaced excerpt means the owner will never find it when studying that topic — knowledge that exists but is invisible.
