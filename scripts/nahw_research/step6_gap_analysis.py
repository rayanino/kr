...
Output: reference/research/nahw_corpus_gaps.md
"""
...
def main() -> None:
    ...
    with open(OUTPUT_DIR / "nahw_books_identified.json", encoding="utf-8") as f:
        books_data = json.load(f)

    tree_topics = load_tree_topics(OUTPUT_DIR / "nahw_corpus_tree.yaml")
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Generated by scripts/nahw_research/step6_gap_analysis.py*")
    lines.append("")

    # Write report
    out_path = OUTPUT_DIR / "nahw_corpus_gaps.md"
