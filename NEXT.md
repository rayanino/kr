...
- `_pending_` feat(source): close follow-up 28 (remove dead `LevelProvenance.TAXONOMY_ENGINE` enum value, 344 pass; structural ripgrep trace confirmed dead surface — referenced only in 2 test fixtures, never written by production code; per closed DEC-SRC-0003 OWN_SYNTHESIS adjudication)
...
**Open follow-ups:** 18, 27 (FU-28 closed at this commit; FU-36 closed at preceding commits).
