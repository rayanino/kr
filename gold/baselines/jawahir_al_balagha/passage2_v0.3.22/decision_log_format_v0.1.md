...
> NOTE: This document is retained for **legacy reference**.
> Current active baselines are governed by Binding Decision #19: decision records must use
> `checklist_version = \"checklists_v0.4\"` when validating against `2_atoms_and_excerpts/checklists_v0.4.md`.
> See `decision_log_format_v0.2.md` for the current format guidance.

**Purpose:** Machine-readable record of every placement decision and edge-case atomization decision, referencing checklist IDs from the checklist file used for validation (canonical: `checklists_v0.4.md`).
...
2. All checklist IDs referenced exist in the checklists file used for validation
...
```json
{
  ...
  "checklist_version": "checklists_v0.4",
  "placement_checklist": {
