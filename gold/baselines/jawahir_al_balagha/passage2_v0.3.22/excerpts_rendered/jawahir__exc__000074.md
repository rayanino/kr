...
# jawahir:exc:000074 — جواب — (7) مصوون: شاذة وليست فصيحة لمخالفتها للقياس الصرفي.

- excerpt_id: `jawahir:exc:000074`
...
BOUNDARY: Starts at core atom jawahir:fn:000048 and ends at jawahir:fn:000048. Boundary aligns with the smallest self-contained unit for this answer in the footnote layer.
...
## Core atoms
- `jawahir:fn:000048`  (type=prose_sentence, role=exercise_answer_content)
