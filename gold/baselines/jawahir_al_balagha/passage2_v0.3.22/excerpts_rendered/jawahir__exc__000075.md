...
# jawahir:exc:000075 — جواب — (8) البعاق مطر السحاب، والجرد حل الوادي - وليستا فصيحتين

- excerpt_id: `jawahir:exc:000075`
...
BOUNDARY: Starts at core atom jawahir:fn:000049 and ends at jawahir:fn:000049. Boundary aligns with the smallest self-contained unit for this answer in the footnote layer.
...
## Core atoms
- `jawahir:fn:000049`  (type=prose_sentence, role=exercise_answer_content)
