# Decision Log Format — v0.2

**Purpose:** Machine-readable record of every placement decision and edge-case atomization decision, referencing checklist IDs from `checklists_v0.4.md`.

**Version rule (binding):** `excerpt_decision.checklist_version` MUST match the checklist file used for validation (e.g., `checklists_v0.4`).
...
2. All checklist IDs referenced exist in `checklists_v0.4.md`
3. All mandatory placement checklist items (PLACE.P1–P8) are present with boolean values
