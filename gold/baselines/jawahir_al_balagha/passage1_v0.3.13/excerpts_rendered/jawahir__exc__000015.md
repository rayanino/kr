...
# تطبيق 2: غرابة ألفاظ كتاب الأمير (ص ٢٥؛ matn 000056)

- excerpt_id: `jawahir:exc:000015`
...
BOUNDARY: Atom 056 quotes an Arab prince's letter filled with obscure words (صلبة, خريعة, حضرمية, ممغورة, مأسودة — all requiring glosses). Tests غرابة: words that require تتبع اللغات.
...
## Core atoms
- `jawahir:matn:000056`  (type=bonded_cluster, role=exercise_content)
  وقال بعض أمراء العرب، وقد اعتلت أمّه، فكتب رقاعاً وطرحها في المسجد الجامع بمدينة السلام: صين امرؤ وَرَعَا، دعا لامراة انقحلة مقسئنة قد منيت بأكل الطرموق فأصابها من أجله الاستمصال بأن يمن الله عليها بالاطرعشاش والابرغشاش
